...
var _slicedToArray = function () { function sliceIterator(arr, i) { var _arr = []; var _n = true; var _d = false; var _e = undefined; try { for (var _i = arr[Symbol.iterator](), _s; !(_n = (_s = _i.next()).done); _n = true) { _arr.push(_s.value); if (i && _arr.length === i) break; } } catch (err) { _d = true; _e = err; } finally { try { if (!_n && _i["return"]) _i["return"](); } finally { if (_d) throw _e; } } return _arr; } return function (arr, i) { if (Array.isArray(arr)) { return arr; } else if (Symbol.iterator in Object(arr)) { return sliceIterator(arr, i); } else { throw new TypeError("Invalid attempt to destructure non-iterable instance"); } }; }(); // import exists from './exists'
...
function decompose(processors, input) {
  ...
  var item = (0, _first2.default)(processors, each);
...
var Crawler = function () {
  ...
  _createClass(Crawler, [{
    ...
    value: function flat(it, callback) {
      ...
      var processors = [{ name: 'array', test: isArray, unit: genericProcessor }, { name: 'object', test: isObject, unit: genericProcessor }];
